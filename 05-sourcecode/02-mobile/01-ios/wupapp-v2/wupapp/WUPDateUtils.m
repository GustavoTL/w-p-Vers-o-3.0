...
+(NSString*) timeElapsedBetweenDateFrom:(NSString*) dateFrom AndDateTo:(NSString*) dateTo AndFormat:(NSString*) format
{
    ...
    return [WUPDateUtils timeElapsedBetweenDateFrom:dateFromDt AndDateTo:dateToDt];
}
...
+(NSString*) timeElapsedLongFormatBetweenDateFrom:(NSString*) dateFrom AndDateTo:(NSString*) dateTo AndFormat:(NSString*) format
{
    ...
    return [WUPDateUtils timeElapsedLongFormatBetweenDateFrom:dateFromDt AndDateTo:dateToDt];
}
...
+(NSDate*) convertDateInUTC:(NSDate*)date{
    ...
    NSDate *dtUTC = [utc dateFromString:[WUPDateUtils convertToString:date WithFormat:@"dd/MM/yyyy HH:mm:ss Z"]];
...
+(NSString*) convertDateInUTCString:(NSDate*)date{
    ...
    [utc setTimeZone:[NSTimeZone timeZoneWithName:@"UTC"]];
    [utc setDateFormat:@"dd/MM/yyyy HH:mm:ss Z"];
    NSString *dtUTC = [utc stringFromDate:date];
    return dtUTC;
}
